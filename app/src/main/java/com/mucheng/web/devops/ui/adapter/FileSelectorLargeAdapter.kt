...
class FileSelectorLargeAdapter(
    private val context: Context,
    private val fileList: List<FileItem>
) : RecyclerView.Adapter<FileSelectorLargeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(inflater.inflate(R.layout.layout_file_selector_large, parent, false))
    }
